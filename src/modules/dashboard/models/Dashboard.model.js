 ...
 * ✅ تم إضافة data و config حتى تظهر بيانات الحساسات الحقيقية
 * في أي مكان يستخدم toPublicJSON (مثل النسخ / الإدارة)
 */
dashboardSchema.methods.toPublicJSON = function() {
  return {
    ...
    widgets: this.widgets.map(w => ({
      ...
      data: w.data,      // ✅ تمت الإضافة
      config: w.config   // ✅ تمت الإضافة
    })),
